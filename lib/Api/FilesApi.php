...
class FilesApi
{
     ...
     * @param  string $sort values to sort by (optional, default to 'CreatedDateUtc')
     * @param  string $direction direction to sort by (optional)
     * @throws \XeroAPI\XeroPHP\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \XeroAPI\XeroPHP\Models\File\Association[]
     */
    public function getAssociationsByObject($xero_tenant_id, $object_id, $pagesize = null, $page = null, $sort = 'CreatedDateUtc', $direction = null)
    {
     ...
     * @return array of \XeroAPI\XeroPHP\Models\File\Association[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAssociationsByObjectWithHttpInfo($xero_tenant_id, $object_id, $pagesize = null, $page = null, $sort = 'CreatedDateUtc', $direction = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAssociationsByObjectAsync($xero_tenant_id, $object_id, $pagesize = null, $page = null, $sort = 'CreatedDateUtc', $direction = null)
    {
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface */
    public function getAssociationsByObjectAsyncWithHttpInfo($xero_tenant_id, $object_id, $pagesize = null, $page = null, $sort = 'CreatedDateUtc', $direction = null)
    {
        $returnType = '\XeroAPI\XeroPHP\Models\File\Association[]';
        $request = $this->getAssociationsByObjectRequest($xero_tenant_id, $object_id, $pagesize, $page, $sort, $direction);
        return $this->client
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request  */
    protected function getAssociationsByObjectRequest($xero_tenant_id, $object_id, $pagesize = null, $page = null, $sort = 'CreatedDateUtc', $direction = null)
    {
        // verify the required parameter 'xero_tenant_id' is set
        if ($xero_tenant_id === null || (is_array($xero_tenant_id) && count($xero_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
